...
const BLOG = {
  AUTHOR: '雷公子leigongzi', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'http://leigongzi.cn', // 网站地址
  KEYWORDS: 'Notion, 雷公子,powerbi', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  FONT: 'Arial','Microsoft YaHei','黑体','宋体',sans-serif, // 文章字体 ['font-sans', 'font-serif', 'font-mono'] @see https://www.tailwindcss.cn/docs/font-family
  FONT_AWESOME_PATH:
